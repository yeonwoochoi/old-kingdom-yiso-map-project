...
namespace MoreMountains.Feedbacks {
    [AddComponentMenu("")]
    public class YisoFeedbacksHelpers : MonoBehaviour {
        /// <summary>
    ...
    public class YisoFeedbackReadOnlyAttribute : PropertyAttribute {
    }

    [System.AttributeUsage(System.AttributeTargets.Field)]
    public class YisoFeedbackInspectorButtonAttribute : PropertyAttribute {
        public readonly string MethodName;

        public YisoFeedbackInspectorButtonAttribute(string MethodName) {
    ...
    [AttributeUsage(
        ...
        Inherited = true)]
    public class YisoFeedbackEnumConditionAttribute : PropertyAttribute {
        ...
        public YisoFeedbackEnumConditionAttribute(string conditionBoolean, params int[] enumValues) {
...
#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof(YisoFeedbackInspectorButtonAttribute))]
    public class YisoFeedbackInspectorButtonPropertyDrawer : PropertyDrawer {
        private MethodInfo _eventMethodInfo = null;

        public override void OnGUI(Rect position, SerializedProperty prop, GUIContent label) {
            YisoFeedbackInspectorButtonAttribute inspectorButtonAttribute =
                (YisoFeedbackInspectorButtonAttribute) attribute;
    ...
    public class YisoFeedbackInformationAttribute : PropertyAttribute {
        ...
        public YisoFeedbackInformationAttribute(string message, InformationType type, bool messageAfterProperty) {
    ...
    public class YisoFeedbackHiddenAttribute : PropertyAttribute {
    }

    [AttributeUsage(
        System.AttributeTargets.Field | AttributeTargets.Property | AttributeTargets.Class | AttributeTargets.Struct,
        Inherited = true)]
    public class YisoFeedbackConditionAttribute : PropertyAttribute {
        public string ConditionBoolean = "";
        public bool Hidden = false;
        public bool Negative = false;

        public YisoFeedbackConditionAttribute(string conditionBoolean) {
            this.ConditionBoolean = conditionBoolean;
            this.Hidden = false;
            this.Negative = false;
        }

        public YisoFeedbackConditionAttribute(string conditionBoolean, bool hideInInspector) {
            this.ConditionBoolean = conditionBoolean;
            this.Hidden = hideInInspector;
            this.Negative = false;
        }

        public YisoFeedbackConditionAttribute(string conditionBoolean, bool hideInInspector, bool negative) {
            this.ConditionBoolean = conditionBoolean;
            this.Hidden = hideInInspector;
    ...
    public class YisoFeedbackVectorAttribute : PropertyAttribute {
        public readonly string[] Labels;

        public YisoFeedbackVectorAttribute(params string[] labels) {
            Labels = labels;
        }
    }

#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof(YisoFeedbackVectorAttribute))]
    public class MMVectorLabelsAttributeDrawer : PropertyDrawer {
        ...
        public override void OnGUI(Rect rect, SerializedProperty property, GUIContent guiContent) {
            YisoFeedbackVectorAttribute vector = (YisoFeedbackVectorAttribute) attribute;
        ...
        protected T[] DrawFields<T>(Rect rect, T[] vector, string mainLabel,
            System.Func<Rect, GUIContent, T, T> fieldDrawer, YisoFeedbackVectorAttribute vectors) {
            T[] result = vector;
    ...
    public class YisoFeedbackHiddenPropertiesAttribute : Attribute {
        public string[] PropertiesNames;

        public YisoFeedbackHiddenPropertiesAttribute(params string[] propertiesNames) {
    ...
    [AttributeUsage(
        AttributeTargets.Field | AttributeTargets.Property | AttributeTargets.Class | AttributeTargets.Struct,
        Inherited = true)]
    public class YisoFeedbackInspectorGroupAttribute : PropertyAttribute {
        ...
        public YisoFeedbackInspectorGroupAttribute(string groupName, bool groupAllFieldsUntilNextGroupAttribute = false,
    ...
    public static class YisoFeedbackStaticMethods {
        ...
        public static Type YisoFeedbackGetTypeByName(string name) {
        ...
        /// <param name="this"></param>
        /// <returns></returns>
        public static T YisoFeedbackGetComponentNoAlloc<T>(this GameObject @this) where T : Component {
        ...
        /// <returns></returns>
        public static object YisoFeedbackGetObjectValue(this SerializedProperty property) {
            if (property == null) {
                return null;
            }
            ...
            foreach (var element in elements) {
                if (!element.Contains("[")) {
                    targetObject = YisoFeedbackGetPropertyValue(targetObject, element);
                }
                else {
                    ...
                    targetObject = YisoFeedbackGetPropertyValue(targetObject, elementName, elementIndex);
                }
            }
        ...
        private static object YisoFeedbackGetPropertyValue(object source, string propertyName) {
            if (source == null) {
                return null;
            }
        ...
        private static object YisoFeedbackGetPropertyValue(object source, string propertyName, int index) {
            var enumerable = YisoFeedbackGetPropertyValue(source, propertyName) as System.Collections.IEnumerable;
            if (enumerable == null) {
                return null;
            }
    ...
    public static class YisoFeedbackFieldInfo {
        public static Dictionary<int, List<FieldInfo>> FieldInfoList = new Dictionary<int, List<FieldInfo>>();


        public static int GetFieldInfo(YisoFeedback target, out List<FieldInfo> fieldInfoList) {
